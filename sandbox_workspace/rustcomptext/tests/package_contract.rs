use rustcomptext::codec::encode::build_plain_v1_package;
use rustcomptext::config::Config;
use rustcomptext::hash::sha256_hex;
...
fn test_build_plain_v1_package_config_hash_is_deterministic() {
    ...
    let config_json = rustcomptext::config::config_to_stable_json(&config).unwrap();
