...
| Replay sensitivity-analysis artifact and CI summary | [`docs/iterative_replay_degradation.md#replay-sensitivity-analysis-surface`](docs/iterative_replay_degradation.md#replay-sensitivity-analysis-surface) |
