...
def test_lmcache_replay_integrity_run():
    holdout_dir = "/data/data/com.termux/files/home/antigravity_v7_sandbox/datasets/lmcache_holdout"
    ...
    # Save results.json
    results_path = "/data/data/com.termux/files/home/antigravity_v7_sandbox/artifacts/lmcache_holdout_results.json"
