...
def test_blind_holdout_tournament():
    ...
    # Save to artifacts
    output_path = "/data/data/com.termux/files/home/antigravity_v7_sandbox/artifacts/antigravity_holdout_results.json"
    with open(output_path, "w") as f:
        json.dump(final_output, f, indent=2)
        
    # Save also to reports
    report_json_path = "/data/data/com.termux/files/home/antigravity_v7_sandbox/reports/antigravity_holdout_results.json"
